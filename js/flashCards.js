...
const cardsData = [
  ...
  {
    question: "to examine computes data and change it",
    answer: "to parse",
  },
  {
...
function createCard(data, index) {
  ...
  card.innerHTML = `
    <div class="inner-card">
        ...
        <p class="textInside">${data.question}</p>
    </div>
    <div class="inner-card-back">
        <p class="textInside">${data.answer}</p>
    </div>
    </div>
  `;
...
//         console.log('You clicked square num 2');
//         break;
//         case aboveLeft: 
//         // name of the function
//         console.log('You clicked square num 1');
//         break;
//         case bottomRight: 
//         // name of the function
//         console.log('You clicked square num 4');
//         break;
//         case bottomLeft: 
//         // name of the function
//         console.log('You clicked square num 3');
//         break;
//     }    
